package com.dianaqa.gitworkflow;
...
public class GitWorkFlow {
    ...
    public static void main(String[] args) {
     ...
     // As result, there are 2 branch on the local memory: master & task_1, and on the cloud we have only one branch: origin/master

        String step5 = "Add the change related to the task_1, being on the task_1 branch";
        String step6 = "Add the change into history of the local branch task_1 - git commit";
